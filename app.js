...
const paymentRoutev2 = require('./lib/payments/mastercard/index');
const paymentRoutev3 = require('./lib/payments/mastercard/gateway');
const app = express();
...
const store = new MongoDBStore({
    uri: getDbUri(config.databaseConnectionString1),
    collection: 'sessions'
});
...
app.use(`/${config.paymentGateway}`, paymentRoutev2);
app.use(`/${config.paymentGateway}`, paymentRoutev3);
...
initDb(config.databaseConnectionString1, async (err, db) => {
